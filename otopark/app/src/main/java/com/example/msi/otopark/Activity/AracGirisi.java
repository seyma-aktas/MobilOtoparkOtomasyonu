                            ...
                            HashMap<String, String> plakalar = (HashMap<String, String>) ds.getValue();
                                if(plakalar.containsValue(plaka.getText().toString())){
                                    dbRef.child("aracGiris").child(plaka.getText().toString()).setValue(
                                            new UserAracGiris(plaka.getText().toString(),strdate));
                                    Toast.makeText(getApplicationContext(), "Araç Girişi Yapıldı!", Toast.LENGTH_LONG).show();

                                }
                                else{

                                    Toast.makeText(getApplicationContext(), "Plaka Bulunamadı,Müşteri Kayıtlı Değil!", Toast.LENGTH_LONG).show();
